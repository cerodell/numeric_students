...
def param():
    ...
    tau_max = 0.          # wind stress maximum (kg m/s^2)
...
def main(time, loop, param):
    ...
    print("Loop set to:  ", loop)
    psi = qg(time, loop, param)
    fig, ax = plt.subplots(1, 1, figsize=(10,8))
    fig.suptitle('SOR scheme loop set to:   ' + str(loop), fontsize=16)
